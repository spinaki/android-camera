...
//    public static String compressedImageFromBitmap(Bitmap bitmap, Context context, String fileName) {
//        try {
...
//        try {
//            File folder = new File(FileUtils.getAppTempFolderPath(context));
//            folder.mkdirs();
//            if (TextUtils.isEmpty(fileName)) {
//                fileName = Constants.APP_TEMP_FILE_NAME;
//            }
//
